...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        ...
        "2\\. أرسل صور صفحات المانغا دفعة واحدة أو واحدة تلو الأخرى\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    text = (
        ...
        "📦 *نظام الجلسات:*\n"
        "الجلسة تتيح لك إرسال عدد كبير من الصور، ويقوم البوت بمعالجتها بصمت في الطابور\\. "
        ...
        "⏳ *ملاحظة حول الطابور:*\n"
        "يتم معالجة الصور بالتتابع لضمان الجودة\\. ستظهر لك رسالة تخبرك بمكانك في الطابور والوقت المتوقع\\."
    )
